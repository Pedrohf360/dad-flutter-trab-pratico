...
class AssociadoCadPage extends StatefulWidget {
  @override
  _AssociadoCadPageState createState() => new _AssociadoCadPageState();
}

class _AssociadoCadPageState extends State<AssociadoCadPage> {

  final formKey = GlobalKey<FormState>();
  String _usuario, _senha, _cpf, _tipo = "associado";
